...
Простенькая задачка на кодировку. Исходя из текста задачи + логики(если таковая имеется), понимаем, что ето russian language, значит декодим эти кракозябры с кодировкой WINDOWS-1251, например тут: https://2cyr.com/decode.
...
Задача полностью аналогична предыдущей:

```
python3 RsaCtfTool.py -e 65537 -n 561985565696052620466091856149686893774419565625295691069663316673425409620917583731032457879432617979438142137 --uncipher 481703757459489253151592024992166924694204851942945587017305638831069582561499174501535714239217499438195328607
```
