...
Делаем вывод, что именно на нем обрывается рекурсия, значит ищем файл, в котором он упоминается. Рукми это делать долго, т.к их всего сотня, знаит пишем простой скриптец на Python:
