...
Делаем вывод, что именно на нем обрывается рекурсия, значит ищем файл, в котором упоминается название этого(1337.html), рукми это делать долго, т.к их всего сотня, знаит пишем простой скриптец на Python:
